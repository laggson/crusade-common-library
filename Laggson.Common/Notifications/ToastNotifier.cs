...
namespace Laggson.Common.Notifications
{
    ...
    public class ToastNotifier
    {
        ...
        public static void TestNeueMethode()
        {
            /**
            var t2 = "<toast>" + 
                "<visual>" + 
                  "<binding template=\"ToastImageAndText04\">" + 
                    "<image id=\"1\" src=\"C:\\Users\\marku\\AppData\\Local\\Temp\\TimeTrack\\icon.png\"/>" + 
                    "<text id=\"1\">Guten Morgen!</text>" + 
                    "<text id=\"2\">Beginn heute: 10:13</text>" + 
                    "<text id=\"3\">5 Einträge wurden geladen.</text>" + 
                  "</binding>" + 
                "</visual>" + 
              "</toast>";
    */
            ...
            var template = "<toast launch=\"app-defined-string\">" +
                "<visual>" +
                 "<binding template =\"ToastGeneric\">" +
                  ...
                  "<text>Kannst du das hier lesen?</text>" +
                 "</binding>" +
                "</visual>" +
                "<actions>" +
                 "<action activationType=\"background\" content=\"Ja\" arguments=\"yes\"/>" +
                 "<action activationType=\"background\" content=\"Nein\" arguments=\"no\"/>" +
                "</actions>" +
               "</toast>";
            ...
            var notification = ToastNotificationManager.CreateToastNotifier(ApplicationName);
